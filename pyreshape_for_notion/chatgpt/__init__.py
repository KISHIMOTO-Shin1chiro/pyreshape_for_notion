"""
pyreshape_for_notion.chatgpt

ChatGPT 公式エクスポート用パイプライン。
入力は 0_raw_export フォルダ内の conversations-*.json 群。

高レベル使用例:
  from pyreshape_for_notion import chatgpt
  chatgpt.full_export(
      raw_export_dir=".../Log_ChatGPT/v3/0_raw_export",
      base_dir=".../Log_ChatGPT/v3",
  )
