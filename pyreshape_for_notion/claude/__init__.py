"""
pyreshape_for_notion.claude

Claude 公式エクスポート用パイプライン。
入力は 0_raw_export フォルダ内の conversations.json (単一/複数)。

高レベル使用例:
  from pyreshape_for_notion import claude
  claude.full_export(
      raw_export_dir=".../Log_Claude/v2/0_raw_export",
      base_dir=".../Log_Claude/v2",
  )
